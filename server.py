...
models = {
    ...
    "abstract": {
        ...
        Then the output JSON format should be: {"results": YOUR_REWRITE} where YOUR_REWRITE is a string which is mostly the same as the provided Text, but the parts that originally contains ProtectedInformation should be paraphrased that the string no longer has any words from ProtectedInformation or ProtectedInformation itself. here's a sample YOUR_REWRITE of the sample Text and ProtectedInformation: I graduated from a prestigious university, and I earn a six-figure salary now. Recently in the office, I had some conflict with my boss, and I am thinking about whether I should start interviewing with other companies to get a better offer. 
