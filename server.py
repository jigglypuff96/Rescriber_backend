...
models = {
    ...
    "abstract": {
        ...
        Then the output JSON format should be: {"results": YOUR_REWRITE} where YOUR_REWRITE is a string that has the same meaning as the Text provided. This string should be a copy of Text but with a paraphrased version for the parts that originally contains ProtectedInformation. Therefore, the string no longer has any words from ProtectedInformation or ProtectedInformation itself. 
        Here's a sample YOUR_REWRITE of the sample Text and ProtectedInformation: I graduated from a prestigious university, and I earn a six-figure salary now. Recently in the office, I had some conflict with my boss, and I am thinking about whether I should start interviewing with other companies to get a better offer. 
